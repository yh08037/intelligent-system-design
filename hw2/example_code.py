...
'''
example_code.py :
    example code for hw02-1.py and hw02-2.py
    classification of setosa vs versicolor
'''
...
target_label = ['Iris-setosa', 'Iris-versicolor']
target_name = ['Setosa', 'Versicolor']
